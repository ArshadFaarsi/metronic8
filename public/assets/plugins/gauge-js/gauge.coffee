...
do () ->
	agents = ['ms', 'moz', 'webkit', 'o']
	for agent in agents
		if window.requestAnimationFrame
			break
		window.requestAnimationFrame = window[agent + 'RequestAnimationFrame']
		window.cancelAnimationFrame = window[agent + 'CancelAnimationFrame'] or window[agent + 'CancelRequestAnimationFrame']
