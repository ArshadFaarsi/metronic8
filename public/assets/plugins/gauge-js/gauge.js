...
(function() {
  ...
  (function() {
    var browserRequestAnimationFrame, isCancelled, lastId, agent, agents, _i, _len;
    ...
    for (_i = 0, _len = agents.length; _i < _len; _i++) {
      ...
      window.cancelAnimationFrame = window[agent + 'CancelAnimationFrame'] || window[agent + 'CancelRequestAnimationFrame'];
    }
