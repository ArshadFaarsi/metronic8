...
$(document).on('click', '#overview_btn', function() {
    ...
    $('#kt_profile_details_view').removeClass('d-none');
    $('#kt_profile_details_update').addClass('d-none');
    $('#kt_account_settings_signin_method_update').addClass('d-none');
});
$(document).on('click', '#setting_btn', function() {
    $(this).addClass('active');
    $('#overview_btn').removeClass('active');
    $('#kt_profile_details_view').addClass('d-none');
    $('#kt_profile_details_update').removeClass('d-none');
    $('#kt_account_settings_signin_method_update').removeClass('d-none');
});
$(document).on('click', '#edit_profile', function() {
    $('#setting_btn').addClass('active');
    $('#overview_btn').removeClass('active');
    $('#kt_profile_details_view').addClass('d-none');
    $('#kt_profile_details_update').removeClass('d-none');
    $('#kt_account_settings_signin_method_update').removeClass('d-none');
