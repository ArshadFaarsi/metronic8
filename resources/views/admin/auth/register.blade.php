        ...
        <div class="card rounded-3 w-md-550px">
            ...
            <div class="card-body d-flex flex-column p-10 p-lg-20 pb-lg-10">
                ...
                <div class="d-flex flex-center flex-column-fluid pb-15 pb-lg-20">
                    <!--begin::Form-->
                    <form class="form w-100" novalidate="novalidate" method="POST" id="kt_sign_up_form"
                        data-kt-redirect-url="{{url('admin/login')}}" action="{{url('admin/register')}}">
                        @csrf
                        <!--begin::Heading-->
                        <div class="text-center mb-11">
                            ...
                            <!--end::Title-->
                            <!--begin::Subtitle-->
                            <div class="text-gray-500 fw-semibold fs-6">Choose email address and password</div>
                            <!--end::Subtitle=-->
                        </div>
                        <!--begin::Heading-->
                        <!--begin::Input group=-->
