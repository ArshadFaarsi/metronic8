                                    ...
                                    <div class="row gy-10">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <a href="../../demo1/dist/dashboards/social.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                    <img src="{{asset('assets')}}/media/preview/demos/placeholder.jpg" data-src="{{asset('assets')}}/media/preview/prebuilts/dashboards/social.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                            ...
                                            <div class="row g-10">
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo1/dist/authentication/email/promo-2.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                            <img src="{{asset('assets')}}/media/preview/demos/placeholder.jpg" data-src="{{asset('assets')}}/media/preview/prebuilts/pages/email-promo2.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
