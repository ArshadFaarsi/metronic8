<head>
    <title>Admin Panel | EeasyLoade</title>
    <meta charset="utf-8" />
    ...
    <!-- multiselect css-->
    <link href="{{ asset('public/assets') }}/css/select2.css" rel="stylesheet" type="text/css" />
    <link href="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.5/css/select2.min.css" rel="stylesheet" />
    <!--end::Global Stylesheets Bundle-->
    <!--begin::custom css (as per page)-->
    @stack('head-css');
    <!--end::custom css-->
    <!--begin::custom js (as per page)-->
    @stack('head-js');

    <script>
        var ajxRoute = {
            user_status_change: "{{ route('admin.users.status') }}",
            user_get_user: "{{ route('admin.users.show', 'get_user') }}",
        }
    </script>
    <!--end::custom js-->
